...
const API_BASE_URL = process.env.VUE_APP_API_URL || "http://localhost:3100";
  ...
  actions: {
    ...
    async fetchArticles(options = {}) {
      ...
      try {
        ...
        this.error =
          error.response?.data?.message || "Error cargando artículos";
    ...
    async fetchFeaturedArticles(limit = 5) {
      ...
      try {
        ...
        this.error =
          error.response?.data?.message || "Error cargando destacados";
    ...
    async fetchArticlesByCategory(category, includeUnpublished = false) {
      ...
      try {
        ...
        this.error =
          error.response?.data?.message || "Error cargando categoría";
    ...
    async updateArticle(id, articleData) {
      ...
      try {
        ...
        this.error =
          error.response?.data?.message || "Error actualizando artículo";
    ...
    async publishArticle(id) {
      ...
      try {
        ...
        this.error =
          error.response?.data?.message || "Error publicando artículo";
    ...
    async archiveArticle(id) {
      ...
      try {
        ...
        this.error =
          error.response?.data?.message || "Error archivando artículo";
    ...
    async deleteArticle(id) {
      ...
      try {
        ...
        this.error =
          error.response?.data?.message || "Error eliminando artículo";
    ...
    async fetchArticleHistory(id, limit = 10) {
      ...
      try {
        ...
        this.error =
          error.response?.data?.message || "Error cargando historial";
    ...
    async restoreArticleVersion(id, version, author = "Admin") {
      ...
      try {
        ...
        this.error =
          error.response?.data?.message || "Error restaurando versión";
